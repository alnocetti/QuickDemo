<@layout.layout; section>	
    ...
    <div class="page-header light-fg d-flex flex-column justify-content-center justify-content-lg-end p-6">
        ...
        <div
            ...
            <div class="user-info flex-column row flex-lg-row no-gutters align-items-center">
                ...
                <img class="profile-image avatar huge mr-6" src="../assets/images/avatars/katherine.jpg">

                <div class="name h2 my-6">Katherine Wilson</div>
            ...
            <div class="actions row align-items-center no-gutters">
                ...
                <button type="button" class="btn btn-secondary ml-2" aria-label="Send Message">Send Message</button>
    ...
    <div class="page-content">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link btn active" id="timeline-tab" data-toggle="tab" href="#timeline-tab-pane" role="tab"
        ...
        <div class="timeline col-12 col-sm-7 col-xl-9">
            ...
            <div class="profile-box add-post card">
                ...
                <div class="form">
                    ...
                    <textarea class="w-100 p-4" placeholder="Write something.."></textarea>
                    ...
                    <footer class="row no-gutters align-items-center justify-content-between bg-light p-2">
                        ...
                        <button type="post-button button" class="btn btn-secondary" aria-label="post">
                            POST
                        </button>
                ...
                <div class="timeline-item card mb-6">
                    ...
                    <div class="content">
                            ...
                            <div class="post-media py-2 px-4">
                                    ...
                                    <img class="media-img" src="../assets/images/etc/early-sunrise.jpg">
                    ...
                    <footer class="bg-light p-4">
                            ...
                            <div class="comment-count mb-4">
                                ...
                                <div class="comment row no-gutters mb-6">
                                    ...
                                    <img src="../assets/images/avatars/alice.jpg" class="col-auto avatar mr-2"/>
                        ...
                        <div class="reply row no-gutters">
                            ...
                            <img src="../assets/images/avatars/profile.jpg" class="col-auto avatar mr-2"/>

                            <form class="col">

                                <textarea class="p-2 mb-2 w-100" placeholder="Add a comment..."></textarea>

                                <button type="button" class="post-comment-button btn btn-sm btn-secondary"
                    ...
                    <header class="row no-gutters align-items-center justify-content-between p-4">
                        ...
                        <div class="user col">
                            ...
                            <div class="row no-gutters align-items-center justify-content-start">
                                ...
                                <img class="avatar col-auto mr-2" src="../assets/images/avatars/andrew.jpg">
                    ...
                    <div class="content">
                            ...
                            <div class="article py-2 px-4">
                                ...
                                <div class="post-media">
                                    <img class="media-img" src="../assets/images/etc/fallout.jpg">
                                </div>

                                <div class="title px-4 pt-4">The Fallout 4 Pip-Boy Edition Is Back In Stock Now</div>

                                <div class="subtitle px-4 pt-1">Kotaku</div>

                                <div class="excerpt p-4">The Fallout 4 Pip-Boy edition is back in stock at Gamestop, for all 3 platforms. Additionally, Walmart also has it in stock for the PS4 and Xbox One as of this writing, as does Best Buy.</div>
                    ...
                    <header class="row no-gutters align-items-center justify-content-between p-4">
                        ...
                        <div class="user col">
                            ...
                            <div class="row no-gutters align-items-center justify-content-start">
                                ...
                                <img class="avatar col-auto mr-2" src="../assets/images/avatars/carl.jpg">
                ...
                <div class="timeline-item card mb-6">
                    ...
                    <header class="row no-gutters align-items-center justify-content-between p-4">
                        ...
                        <div class="user col">
                            ...
                            <div class="row no-gutters align-items-center justify-content-start">
                                ...
                                <img class="avatar col-auto mr-2" src="../assets/images/avatars/jane.jpg">
                    ...
                    <div class="content">
                            ...
                            <div class="post-media py-2 px-4">
                                    ...
                                    <iframe src='https://player.vimeo.com/video/87993762' width='500' height='281' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <div><a href='https://vimeo.com/87993762'>Durak (Stop) - 2014 (Animated Short Film)</a> from <a href='https://vimeo.com/user6727540'>serdarcotuk</a> on <a href='https://vimeo.com'>Vimeo</a>.</div>
            ...
            <div class="profile-box info-box general card mb-4">
                ...
                <div class="content p-4">
                    ...
                    <div class="info-line">
                        ...
                        <div class="info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eget pharetra felis, sed ullamcorper dui. Sed et elementum neque. Vestibulum pellente viverra ultrices. Etiam justo augue, vehicula ac gravida a, interdum sit amet nisl. Integer vitae nisi id nibh dictum mollis in vitae tortor.</div>
                    </div>
                        ...
                        <div class="group row no-gutters align-items-center justify-content-between mb-4">
                            ...
                            <div class="col">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <img class="logo col-auto mr-4" src="../assets/images/logos/android.png"
                                         alt="Android"/>
                        ...
                        <div class="group row no-gutters align-items-center justify-content-between mb-4">
                            ...
                            <div class="col">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <img class="logo col-auto mr-4" src="../assets/images/logos/google.png"
                                         alt="Google"/>
                        ...
                        <div class="group row no-gutters align-items-center justify-content-between mb-4">
                            ...
                            <div class="col">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <img class="logo col-auto mr-4" src="../assets/images/logos/fallout.png"
                                         alt="Fallout"/>
            ...
            <div class="period mb-8">
                ...
                <div class="period-media row no-gutters">
                            ...
                            <div class="media mr-4 mb-4">
                                ...
                                <img class="preview w-100" src="../assets/images/etc/mountain-sunset.jpg"
                            ...
                            <div class="media mr-4 mb-4">
                                ...
                                <img class="preview w-100" src="../assets/images/etc/mountain-lake.jpg"
                                     title="Mountain Lake">
                            ...
                            <div class="media mr-4 mb-4">
                                ...
                                <img class="preview w-100" src="../assets/images/etc/air-balloons.jpg"
